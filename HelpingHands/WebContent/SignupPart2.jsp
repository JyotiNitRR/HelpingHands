		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">OTP Validation</h2>
				</div>
			</div>
			<% String userEmail= "";
			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<form action="EmailValidation" class="signin-form" method="post">
		      		<div class="form-group">
		      			<input type="email" class="form-control" name="email" value="<%=userEmail %>" required readonly>
		      		</div>
	            <div class="form-group">
	              <input id="password-field" type="password" class="form-control" name="received_otp" placeholder="Your OTP" required>
